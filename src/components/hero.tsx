        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-8 tracking-tight">
              Discover{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-instagram-blue via-instagram-pink to-instagram-orange">
                Pre-loved
              </span>{" "}
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              Connect directly with Instagram thrift sellers. Browse unique
              pieces, support sustainable fashion, and enjoy a marketplace with
            ...
            <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-green-500" />
                <span>Trusted Instagram sellers</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-green-500" />
